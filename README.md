...
* [Twelve Data MCP](https://github.com/twelvedata/mcp) - Provides real-time financial market data streaming via WebSockets.
* [Finance Tools MCP](https://github.com/VoxLink-org/finance-tools-mcp) - A toolkit for building AI "investor agents" that analyze macroeconomic data (integrates with FRED).
...
* *(We are currently mapping this space. The official ByteCEO MCP server will be listed here soon.)*
